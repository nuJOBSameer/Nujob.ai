  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between bg-white max-w-6xl mx-auto p-6">
      ...
      <div className="w-full md:w-2/3 md:pl-8 mt-6 md:mt-0">
        ...
        «Зробити процес найму справедливим, ефективним і глибоко персоналізованим. Ми з’єднуємо потрібні таланти з відповідними ролями за допомогою ШІ.»<br/> — Дмитро Бокотей, генеральний директор
        </p>
      </div>
    </div>
  );
