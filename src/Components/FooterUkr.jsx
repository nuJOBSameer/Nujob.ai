...
export default function FooterUkr() {
  return (
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 md:ml-28">
          ...
          <div className="max-w-sm">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              nuJOB — ваш надійний партнер у просуванні кар’єри, що використовує передові технології ШІ, щоб допомогти вам шукати, вдосконалювати та демонструвати свої навички з неперевершеною точністю, ефективністю та індивідуальною підтримкою.
            </p>
