    ...
    <div className="text-center py-6">
      ...
      <div className="flex md:flex-row flex-col items-center justify-center gap-6 mt-6">
        ...
        <div className="w-80 p-4 rounded-lg border text-left border-blue-300  shadow-md">
          ...
          <h3 className="text-black font-semibold ">Save time with reusable, structured templates.</h3>
        ...
        <div className="w-80 p-4 rounded-lg border text-left border-blue-300  shadow-md">
          ...
          <h3 className="text-black font-semibold">Customize each version for specific job requirements.</h3>
        ...
        <div className="w-80 p-4 rounded-lg border text-left border-blue-300  shadow-md">
          ...
          <h3 className="text-black font-semibold">Keep everything organized in one place for seamless access.</h3>
