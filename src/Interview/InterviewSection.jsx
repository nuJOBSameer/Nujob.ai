    ...
    <div className="py-12 px-5 md:px-28">
      ...
      <div className="md:flex-row flex-col-reverse items-center flex justify-center">
        ...
        <div className="ml-7">
          ...
          <p className="font-semibold flex text-gray-800 mt-1">
            <span><img src="/images/Star.png" alt="" className="h-5 w-5 mr-1" /></span> Effortlessly Schedule and Host Live Interviews
          </p>
          ...
          <p className="font-semibold flex text-gray-800 mt-1">
          <span><img src="/images/Star.png" alt="" className="h-5 w-5 mr-1" /></span> AI-Powered Dashboard for Monitoring and Facilitation
          </p>
          <p className="text-gray-600 mt-2">
      ...
      <div className="md:flex-row flex-col items-center flex justify-center mt-12">
        <div>
          ...
          <p className="font-semibold flex text-gray-800 mt-1">
          <span><img src="/images/Star.png" alt="" className="h-5 w-5 mr-1" /></span> Prepare for Interviews with Tailored Simulations
          </p>
          <p className="text-gray-600 mt-2">
          ...
          <p className="font-semibold flex text-gray-800 mt-1">
          <span><img src="/images/Star.png" alt="" className="h-5 w-5 mr-1" /></span> Transforming the way Resumes are Built
          </p>
          <p className="text-gray-600 mt-2">
