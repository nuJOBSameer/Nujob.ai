...
const FeatureCards = () => {
  const features = [
    { title: "Skills List", image: SkillsList },
    { title: "Market Scoring", image: MarketScoring },
    { title: "Candidates Matching", image: CandidatesMatching },
    { title: "AI Skills Validation", image: AISkillsValidation },
    { title: "Profiles Base", image: ProfilesBase },
  ];
